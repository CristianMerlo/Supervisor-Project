...
2.  **Prioridad 2: Validación de Emisores:** Implementar la validación de Chat ID y correo electrónico contra la lista oficial de técnicos habilitados.
3.  **Prioridad 3: Auditoría y Viáticos:** Desarrollar los bloques de visión computacional y conciliación de viáticos.
